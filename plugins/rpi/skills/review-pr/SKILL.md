...
1. **Fix concerns** — Address [major] and [minor] issues directly in code. Apply [nit]s at own discretion. Where a fix touches a comment or docstring, activate the `rpi:document-code` skill.
